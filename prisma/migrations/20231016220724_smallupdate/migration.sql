...
CREATE TABLE "new_Franchise" (
    ...
    "xpNextLevel" INTEGER NOT NULL DEFAULT 100,
...
INSERT INTO "new_Scout" ("bias", "conferenceSpecialty", "cost", "evalNextLevel", "evalXp", "evaluation", "firstName", "franchiseId", "hasUpgrade", "hours", "id", "lastName", "remaining", "reputation", "reputationNextLevel", "reputationXp", "specialty") SELECT "bias", "conferenceSpecialty", "cost", "evalNextLevel", "evalXp", "evaluation", "firstName", "franchiseId", "hasUpgrade", "hours", "id", "lastName", "remaining", "reputation", "reputationNextLevel", "reputationXp", "specialty" FROM "Scout";
DROP TABLE "Scout";
