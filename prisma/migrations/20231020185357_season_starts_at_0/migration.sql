...
INSERT INTO "new_Season" ("averageOvr", "balance", "franchiseId", "id", "name", "scoutsLocked", "week", "year") SELECT "averageOvr", "balance", "franchiseId", "id", "name", "scoutsLocked", "week", "year" FROM "Season";
DROP TABLE "Season";
